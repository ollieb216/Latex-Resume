...
\begin{center}
    ...
    {\large Chappaqua, NY} \\ \vspace{1pt}  % Made location slightly larger with {\small}
    \small 
    ...
    {Availability: August 10th – December 2026}
\end{center}
...
\resumeSubHeadingListStart
    \resumeSubheading{Travelers}{Hartford, CT}{Actuarial Intern (ALDP)}{June 2026 - Aug 2026}
    \resumeItemListStart
        \resumeItem{Actuarial Leadership Development Program: Incoming Summer 2026}
    \resumeItemListEnd
...
{\small \textbf{Algorithmic Investments \& Quantitative Solutions}} \textbar\ \textit{Senior Researcher} \hfill Sept 2025 - Present \\
